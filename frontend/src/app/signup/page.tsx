...
function SignUp() {
  ...
  return (
    <div className="dark:bg-dark">
      <main className="flex justify-center drop-shadow-lg drop-shadow-lg dark:bg-dark pt-5 ">
        <div className="flex justify-center ">
          <div className="w-1/2 border-2 border-gray-900/10 rounded-lg bg-gray-300/20 dark:bg-gray-800 p-8 ">
            <form>
