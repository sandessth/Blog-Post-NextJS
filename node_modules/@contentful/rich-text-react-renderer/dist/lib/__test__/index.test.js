...
var embedded_resource_1 = __importDefault(require("./documents/embedded-resource"));
describe('documentToReactComponents', function () {
    ...
    it('renders marks with default mark renderer', function () {
        var docs = [
            ...
            (0, documents_1.marksDoc)(rich_text_types_1.MARKS.SUPERSCRIPT),
    ...
    it('renders default resource block', function () {
        var resourceSys = {
            sys: {
        ...
        var document = (0, embedded_resource_1.default)(resourceSys);
        expect((0, __1.documentToReactComponents)(document)).toMatchSnapshot();
    });
    ...
    it('renders tables with header', function () {
        expect((0, __1.documentToReactComponents)(documents_1.tableWithHeaderDoc)).toMatchSnapshot();
    });
